...
while(1){adc1_display();
	adc2_display();
	adc3_display();


	meanvalue1=((display1_[2]-0x30)*10+(display1_[1]-0x30));
	((display1_[1]+display2_[1]+display3_[1])/3);
	meanvalue2=(display1_[2]+display2_[2]+display3_[2]);


if(meanvalue2>=0x31) {LED5_=1;LED4_=~LED4_;delay1(100);Motor_CompSlowlyUp();}
else if((meanvalue1>=0x36)&&(meanvalue1<=0x39)){LED4_=0;LED5_=0;delay1(100);}
else  if ((meanvalue2==0x30)&&(meanvalue1<=0x35)){LED4_=1;LED5_=~LED5_;delay1(100);Motor_CompSlowlyDown();}
}
}
