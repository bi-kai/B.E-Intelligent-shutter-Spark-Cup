...
/* 读取温度                            */  
/*******************************************************************/     
adc1_display(void) {LED1_=~LED1_;delay1(50);LED1_=~LED1_;delay1(50);LED1_=~LED1_;
...
/*******************************************************************/
  ...
  { 
	while(1) { 
	adc1_display();
	if(display1_[1]>=0x37){LED5_=1;LED4_=~LED4_;delay1(100);}
else if(display1_[1]<=0x33){LED4_=1;LED5_=~LED5_;delay1(100);}
