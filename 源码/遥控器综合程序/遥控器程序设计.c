...
IAP_CONTR = ENABLE_ISP;         //打开IAP 功能, 设置Flash 操作等待时间 
	{	EEPROM_erase(0x2203);
		EEPROM_erase(0x2203+0x200);
		EEPROM_erase(0x2203+0x200+0x200);
		EEPROM_erase(0x2203+0x200+0x200+0x200);
		EEPROM_erase(0x2203+0x200+0x200+0x200+0x200);
		EEPROM_erase(0x2203+0x200+0x200+0x200+0x200+0x200);
		EEPROM_erase(0x2203+0x200+0x200+0x200+0x200+0x200+0x200);
	}
	EEPROM_IAP_Disable();
*/
}
...
//	if((k%508)==0){disc=(0x2000+((k/511)+1)*0x200+256);EEPROM_erase(disc);}
	if(eeprom_address>(0x21ff)){eeprom_address=0x2000;k=0;
...
uchar si=0,sj=0;
if(Model4_EEPROM_Address>0x21ff){Model4_EEPROM_Address=0x2000;}
	if(Model4_EEPROM_Address<0x21ff){
...
Self_BK_Define4();
delay1(1000);
Model4_SendData_Counter=0x2200;
Model4_Eeprom_Counter=0x2200;
...
if(Model4_rkey==3){Model4_SendData_Counter=0x2200;
Model4_SendFlag1=0;
